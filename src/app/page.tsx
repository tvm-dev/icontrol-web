    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full text-center">
          ...
          <p className="font-thin">Porque você controla sua GRANA!</p> <hr />
          <h1 className="mt-2 text-1xl font-bold text-blue-600 mb-6">
          ...
          <div className="space-y-4">
            ...
            <Link href="/register">
              <button className="mt-3 w-full py-2 px-4 bg-green-600 text-white font-bold rounded hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-150">
                Criar Conta
              </button>
            </Link>
          </div>
