    ...
    <div className="flex items-center justify-center space-x-4 my-5">
      ...
      <div className="relative">
        <select
          id="filter"
          name="filter"
          className="block z-10 w-full md:w-48 mt-1 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
